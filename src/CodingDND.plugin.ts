              ...
              return Settings.SettingPanel.build(
                ...
                new Settings.SettingGroup("Example Plugin Settings").append(
                  new Settings.Textbox(
                    "Textbox",
                    "This should be a description of what this setting is about or blank",
                  ...
                  new Settings.SettingGroup("Example Plugin SubSettings", {
                    shown: true,
                  }).append(
